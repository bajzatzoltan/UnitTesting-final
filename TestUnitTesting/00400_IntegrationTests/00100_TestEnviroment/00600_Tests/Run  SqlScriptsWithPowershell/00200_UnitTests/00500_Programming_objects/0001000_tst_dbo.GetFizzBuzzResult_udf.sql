BEGIN;	
	SET NOCOUNT ON; 
	BEGIN TRY;
		DECLARE	@TESTNUMBER NVARCHAR(50) = '0001000-001';
		DECLARE @METHODNAME NVARCHAR(100) = 'dbo.GetFizzBuzzResult_udf';
		...
		SET @result = AutomateRunTests.dbo.GetFizzBuzzResult_udf
				(
					@number_par
				);
		SET @TESTRESULT = 'True';
...
BEGIN;	
	SET NOCOUNT ON;
	DECLARE	@TESTNUMBER NVARCHAR(50) = '0001000-002';
	DECLARE @METHODNAME NVARCHAR(100) = 'dbo.GetFizzBuzzResult_udf';
...
BEGIN;	
	SET NOCOUNT ON;
	DECLARE	@TESTNUMBER NVARCHAR(50) = '0001000-003';
	DECLARE @METHODNAME NVARCHAR(100) = 'dbo.GetFizzBuzzResult_udf';
...
BEGIN;	
	SET NOCOUNT ON;
	DECLARE	@TESTNUMBER NVARCHAR(50) = '0001000-004';
	DECLARE @METHODNAME NVARCHAR(100) = 'dbo.GetFizzBuzzResult_udf';
	DECLARE	@TESTNAME NVARCHAR(200) = 'Given parameter: 3 and return string: Fizz';
	DECLARE @TESTRESULT NVARCHAR(10) = 'False';
	PRINT CONCAT(@TESTNUMBER,': ',@METHODNAME, ' - ', @TESTNAME); 
	INSERT INTO UnitTesting.dbo.TestResults(TestNumber, MethodName,TestName, TestResult) VALUES (@TESTNUMBER, @METHODNAME, @TESTNAME, @TESTRESULT)
...
BEGIN;	
	SET NOCOUNT ON;
	DECLARE	@TESTNUMBER NVARCHAR(50) = '0001000-005';
	DECLARE @METHODNAME NVARCHAR(100) = 'dbo.GetFizzBuzzResult_udf';
	DECLARE	@TESTNAME NVARCHAR(200) = 'Given parameter: 5 and return string: Buzz';
	DECLARE @TESTRESULT NVARCHAR(10) = 'False';
	PRINT CONCAT(@TESTNUMBER,': ',@METHODNAME, ' - ', @TESTNAME); 
	INSERT INTO UnitTesting.dbo.TestResults(TestNumber, MethodName,TestName, TestResult) VALUES (@TESTNUMBER, @METHODNAME, @TESTNAME, @TESTRESULT)
...
BEGIN;	
	SET NOCOUNT ON;
	DECLARE	@TESTNUMBER NVARCHAR(50) = '0001000-006';
	DECLARE @METHODNAME NVARCHAR(100) = 'dbo.GetFizzBuzzResult_udf';
	DECLARE	@TESTNAME NVARCHAR(200) = 'Given parameter: 6 and return string: Fizz';
	DECLARE @TESTRESULT NVARCHAR(10) = 'False';
	PRINT CONCAT(@TESTNUMBER,': ',@METHODNAME, ' - ', @TESTNAME); 
	INSERT INTO UnitTesting.dbo.TestResults(TestNumber, MethodName,TestName, TestResult) VALUES (@TESTNUMBER, @METHODNAME, @TESTNAME, @TESTRESULT)
...
BEGIN;	
	SET NOCOUNT ON;
	DECLARE	@TESTNUMBER NVARCHAR(50) = '0001000-007';
	DECLARE @METHODNAME NVARCHAR(100) = 'dbo.GetFizzBuzzResult_udf';
	DECLARE	@TESTNAME NVARCHAR(200) = 'Given parameter: 10 and return string: Buzz';
	DECLARE @TESTRESULT NVARCHAR(10) = 'False';
	PRINT CONCAT(@TESTNUMBER,': ',@METHODNAME, ' - ', @TESTNAME); 
	INSERT INTO UnitTesting.dbo.TestResults(TestNumber, MethodName,TestName, TestResult) VALUES (@TESTNUMBER, @METHODNAME, @TESTNAME, @TESTRESULT)
...
BEGIN;	
	SET NOCOUNT ON;
	DECLARE	@TESTNUMBER NVARCHAR(50) = '0001000-008';
	DECLARE @METHODNAME NVARCHAR(100) = 'dbo.GetFizzBuzzResult_udf';
	DECLARE	@TESTNAME NVARCHAR(200) = 'Given parameter: 15 and return string: FizzBuzz';
	DECLARE @TESTRESULT NVARCHAR(10) = 'False';
	PRINT CONCAT(@TESTNUMBER,': ',@METHODNAME, ' - ', @TESTNAME); 
	INSERT INTO UnitTesting.dbo.TestResults(TestNumber, MethodName,TestName, TestResult) VALUES (@TESTNUMBER, @METHODNAME, @TESTNAME, @TESTRESULT)
	...
	DECLARE @expectedResult NVARCHAR(8) = 'FizzBuzz';
