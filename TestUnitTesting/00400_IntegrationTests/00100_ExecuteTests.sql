...
BEGIN;	
	...
	BEGIN TRY;
		...
		DECLARE @testsFilePath  VARCHAR(4000) = 'c:\Users\Bajzát Zoltán\source\repos\bajzatzoltan\UnitTesting-final\TestUnitTesting\00400_IntegrationTests\00100_TestEnviroment\00600_Tests\Run  SqlScriptsWithPowershell\00200_UnitTests\'; --PATH OF POWERSHELL SCRIPT FILE
...
BEGIN;	
	...
	BEGIN TRY;
		...
		-------------------------------------------------
		DECLARE @databaseName VARCHAR(256) = 'AutomateRunTests';
		DECLARE @testsFilePath  VARCHAR(4000) = 'c:\Users\Bajzát Zoltán\source\repos\bajzatzoltan\UnitTesting-final\TestUnitTesting\00400_IntegrationTests\00100_TestEnviroment\00600_Tests\Run_ SqlScriptsWithPowershell\00200_UnitTests\'; --PATH OF POWERSHELL SCRIPT FILE
		DECLARE @testsFileName VARCHAR(256) = 'RunTests.ps1'; --DEFAULT: RunTests.ps1
		DECLARE @userName VARCHAR(256) = NULL; --Parameter is null if the server use windows authentication
		DECLARE @userPassword VARCHAR(256) = NULL; --Parameter is null if the server use windows authentication
		DECLARE @directoryName VARCHAR(256) = '00500_Programming_objects';
...
BEGIN;	
	...
	BEGIN TRY;
		...
		-------------------------------------------------
		DECLARE @databaseName VARCHAR(256) = 'AutomateRunTests';
		DECLARE @testsFilePath  VARCHAR(4000) = 'c:\Users\Bajzát Zoltán\source\repos\bajzatzoltan\UnitTesting-final\TestUnitTesting\00400_IntegrationTests\00100_TestEnviroment\00600_Tests\Run_SqlScriptsWithPowershell\00200_UnitTests\'; --PATH OF POWERSHELL SCRIPT FILE
		DECLARE @testsFileName VARCHAR(256) = 'RunTests.ps1'; --DEFAULT: RunTests.ps1
		DECLARE @userName VARCHAR(256) = NULL; --Parameter is null if the server use windows authentication
		DECLARE @userPassword VARCHAR(256) = NULL; --Parameter is null if the server use windows authentication
		DECLARE @directoryName VARCHAR(256) = '00500_Programming_objects';
...
BEGIN;	
	...
	BEGIN TRY;
		...
		-------------------------------------------------
		DECLARE @databaseName VARCHAR(256) = 'AutomateRunTests';
		DECLARE @testsFilePath  VARCHAR(4000) = 'c:\Users\Bajzát Zoltán\source\repos\bajzatzoltan\UnitTesting-final\TestUnitTesting\00400_IntegrationTests\00100_TestEnviroment\00600_Tests\RunSqlScriptsWithPowershell\00200_UnitTests\'; --PATH OF POWERSHELL SCRIPT FILE
		DECLARE @testsFileName VARCHAR(256) = 'RunTests.ps1'; --DEFAULT: RunTests.ps1
		DECLARE @userName VARCHAR(256) = NULL; --Parameter is null if the server use windows authentication
		DECLARE @userPassword VARCHAR(256) = NULL; --Parameter is null if the server use windows authentication
		DECLARE @directoryName VARCHAR(256) = '00500_Programming_objects';
