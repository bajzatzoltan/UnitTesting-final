...
-------------------------------------------------
CREATE OR ALTER PROCEDURE dbo.AddTestframeworkParameters_usp (
															@serverName VARCHAR(256) = @@SERVERNAME,
															@databaseName VARCHAR(256),
															@testsFilePath VARCHAR(2000),
															@testsFileName VARCHAR(256) = 'RunTests_IntegratedSec.ps1',
...
-------------------------------------------------
CREATE OR ALTER PROCEDURE dbo.ModifyTestframeworkParameters_usp (
															@serverName VARCHAR(256) = @@SERVERNAME,
															@databaseName VARCHAR(256),
...
-------------------------------------------------
CREATE OR ALTER PROCEDURE dbo.DeleteTestframeworkParameters_usp (
																@serverName VARCHAR(256) = @@SERVERNAME,
																@databaseName VARCHAR(256)
																)
AS
...
-------------------------------------------------
CREATE OR ALTER PROCEDURE dbo.AddTestScriptDirectory_usp (	
															@serverName VARCHAR(256) = @@SERVERNAME,
															@databaseName VARCHAR(256),
...
--CREATE PROCEDURE OF ADD TEST SCRIPTS DIRECTORY
-------------------------------------------------
CREATE OR ALTER PROCEDURE dbo.DeleteTestScriptDirectory_usp (	
															@serverName VARCHAR(256) = @@SERVERNAME,
															@databaseName VARCHAR(256),
															@directoryName VARCHAR(256)
															)
...
-------------------------------------------------
CREATE OR ALTER PROCEDURE dbo.ExecuteTests_usp (
												@databaseName VARCHAR(256), 
												@directoryName VARCHAR(256),
												@serverName VARCHAR(256) = @@SERVERNAME
												)
